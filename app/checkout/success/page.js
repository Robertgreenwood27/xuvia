    ...
    <div className="noise" style={{ background: "var(--obsidian)", minHeight: "100vh" }}>
      ...
      <main className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
        <div
          ...
          style={{ border: "1px solid var(--ember)", background: "rgba(200,169,110,0.06)" }}
        >
        ...
        <p className="text-sm leading-relaxed mb-3 max-w-md" style={{ color: "var(--muted)", fontWeight: 300 }}>
          Your order has been placed with Printify. You&apos;ll receive a shipping confirmation
          email once it leaves the print facility.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <Link href="/shop" className="btn-primary" style={{ fontSize: "0.7rem" }}>
            Continue Shopping
          </Link>
